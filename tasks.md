...
|---|---|---|---|
| Phil Stevenson to check with George re: ZILCH-41286 | | 2026-03-06 | Jira: auto-create fix versions on release-please PR merge (In Dev, assigned to George). Questions: why is it on the DevOps board? Does George think he's assigned it to the team by putting it there, or is he actioning it himself? |
