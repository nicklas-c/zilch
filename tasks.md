...
| Find out what work Nick Gilbert did for Platform (Matt Swirski) and dig into what happened | Ephemeral Environments | Nick said he explained how to do it but ended up doing it himself. Want to understand what really happened and what we could have done differently. |
...
| Task | Project | Notes |
|---|---|---|
| Archive Cycle Time Bottleneck Analysis project if no follow-up from Steve | Cycle Time Bottleneck Analysis | Check after 6 Aug. If no further engagement, close the project. |
